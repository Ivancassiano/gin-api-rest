...
func CriaAlunoMock() {
	aluno := models.Aluno{Nome: "Nome do Aluno Teste", CPF: "12345678901",
		RG: "123456789"}
...
func TestVerificaStatusCodeDaSaudacaoComParametro(t *testing.T) {
	...
	req, _ := http.NewRequest("GET", "/Ivan", nil)
	resposta := httptest.NewRecorder()
	r.ServeHTTP(resposta, req)
	assert.Equal(t, http.StatusOK, resposta.Code, "Deveriam ser iguais")
	mockDaResposta := `{"API diz:":"E ai Ivan, tudo beleza?"}`
...
func TestEditaUmAlunoHandler(t *testing.T) {
	...
	aluno := models.Aluno{Nome: "Novo do Aluno Teste", CPF: "42345678901",
		RG: "123456789"}
	...
	assert.Equal(t, "42345678901", alunoMockAtualizado.CPF)
	assert.Equal(t, "123456789", alunoMockAtualizado.RG)
	assert.Equal(t, "Novo do Aluno Teste", alunoMockAtualizado.Nome)
}
